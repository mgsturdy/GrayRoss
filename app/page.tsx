          ...
          <div className="container relative z-10 flex h-full flex-col items-center justify-center text-center text-white">
            ...
            <div className="mt-6 bg-black/60 backdrop-blur-sm px-8 py-4 rounded-md max-w-4xl">
              ...
              <p className="mt-2 text-xl text-secondary">
                Once in a Lifetime Opportunity – 7.99 Acre Waterfront Equestrian Estate
              </p>
              <p className="mt-6 max-w-3xl text-xl font-light text-white/90">
                7520 Balaclava Street, Vancouver BC - A rare 7.99-acre freehold waterfront estate with over 990 feet of
                private Fraser River frontage
              </p>
            </div>
          ...
          <div className="container">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <p className="mt-6 text-xl font-light text-muted-foreground">
                A rare chance to acquire 7.99 acres of prime real estate on the water in Vancouver
              </p>
